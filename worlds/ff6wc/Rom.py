...
treasure_chest_data: Dict[str, Tuple[int, int, int]] = {
    ...
    "Phoenix Cave Lower Cavern Spikes": (0x1E57, 6, 195), # Lower Cavern Spikes and Lower Cavern Rock Jumping were swapped
    "Phoenix Cave Lower Cavern Rock Jumping": (0x1E55, 7, 194), # Lower Cavern Rock Jumping and Lower Cavern Spikes were swapped
